...
(function ($) {
    ...
    function FlightIndicator(placeholder, type, options) {
        ...
        function _setAirSpeed(speed) {
            speed = speed / 100;
            var deg = 0;
            if (speed >= 0 && speed <= 1) deg = (10 / 1) * speed;
            if (speed > 1 && speed <= 2)
                deg = ((29 - 10) / (2 - 1)) * (speed - 1) + 10;
            if (speed > 2 && speed <= 4)
                deg = ((80 - 29) / (4 - 2)) * (speed - 2) + 29;
            if (speed > 4 && speed <= 22)
                deg = ((320 - 80) / (22 - 4)) * (speed - 4) + 80;
            if (speed > 22 && speed <= 25)
                deg = ((360 - 320) / (25 - 22)) * (speed - 22) + 320;
            if (speed >= 25) deg = 360;
        ...
        function _setPitch(pitch) {
            ...
            placeholder.each(function () {
                $(this)
                    ...
                    .css("transform", "translateY(-266px)");
            });
        }
        ...
        function _loadBallPath() {
            if (typeof d3 != "undefined") {
                    ...
                    placeholder.each(function () {
                        ...
                        d3.xml(
                            ...
                            function (xml) {
                                $(i)
                                    .find(
                                        "div.instrument.turn div.turn_ball_path"
                                    )
                ...
                console.log("Unable to find d3js. Will not animate slip ball.");
        }
        ...
        function _setSlip(slip) {
            ...
            if (typeof d3 !== undefined) {
                placeholder.each(function () {
                    ...
                    if (path !== undefined) {
                        var scale =
                            $(this).find("div.instrument.turn").width() / 400;
                        if (slip < 0) slip = 0;
                        else if (slip > 1) slip = 1;
                        var pos = path.getPointAtLength(
                ...
                case "airspeed":
                    $(this).html(
                        '<div class="instrument airspeed"><div class="indicator_background"><img src="' +
                            ...
                            'indicator_background_dashboard_mig21.svg" class="box" alt="" /></div><div class="indicator_background_screws"><img src="' +
                            settings.img_directory +
                ...
                case "attitude":
                    $(this).html(
                        '<div class="instrument attitude"><div class="indicator_background"><img src="' +
                            settings.img_directory +
                            'indicator_background_dashboard_mig21.svg" class="box" style="z-index: 0" alt="" /></div><div class="indicator_background_screws"><img src="'+
                            settings.img_directory +
                            ...
                            settings.img_directory +
                            'ekt_box2.png" class="box" alt="" /></div><div class="attitude_off_flag"></div></div><div class="indicator_foreground"><img src="' +
                            settings.img_directory +
                    ...
                    $(this).html(
                        '<div class="instrument altimeter">' +
                            '<div class="indicator_background">' +
                                '<img src="' +
                                settings.img_directory +
                                'indicator_background_dashboard_mig21.svg" class="box" alt="" />' +
                            '</div>' +
